...
},{"gramene-bins-client":2,"gramene-trees-client":22,"lodash":46,"q":47}],2:[function(require,module,exports){
module.exports = {
  bins: require('./src/bins'),
  binsPromise: require('./src/promise')
};
},{"./src/bins":19,"./src/promise":21}],3:[function(require,module,exports){
...
},{"../adapters/http":4,"../adapters/xhr":4,"_process":61}],8:[function(require,module,exports){
'use strict';
...
},{"./genomes":20,"is-number":45,"lodash":46}],20:[function(require,module,exports){
'use strict';
...
},{"lodash":46}],21:[function(require,module,exports){
...
},{"../spec/support/genomes":18,"./bins":19,"axios":3,"q":47}],22:[function(require,module,exports){
module.exports = {
  taxonomy: require('./src/taxonomy'),
  promise: require('./src/promise')
};

},{"./src/promise":43,"./src/taxonomy":44}],23:[function(require,module,exports){
arguments[4][3][0].apply(exports,arguments)
},{"./lib/axios":25,"dup":3}],24:[function(require,module,exports){
arguments[4][4][0].apply(exports,arguments)
},{"./../defaults":28,"./../helpers/buildUrl":29,"./../helpers/cookies":30,"./../helpers/parseHeaders":32,"./../helpers/transformData":34,"./../helpers/urlIsSameOrigin":35,"./../utils":36,"dup":4}],25:[function(require,module,exports){
arguments[4][5][0].apply(exports,arguments)
},{"./core/InterceptorManager":26,"./core/dispatchRequest":27,"./defaults":28,"./helpers/deprecatedMethod":31,"./helpers/spread":33,"./utils":36,"dup":5,"es6-promise":37}],26:[function(require,module,exports){
arguments[4][6][0].apply(exports,arguments)
},{"./../utils":36,"dup":6}],27:[function(require,module,exports){
arguments[4][7][0].apply(exports,arguments)
},{"../adapters/http":24,"../adapters/xhr":24,"_process":61,"dup":7}],28:[function(require,module,exports){
arguments[4][8][0].apply(exports,arguments)
},{"./utils":36,"dup":8}],29:[function(require,module,exports){
arguments[4][9][0].apply(exports,arguments)
},{"./../utils":36,"dup":9}],30:[function(require,module,exports){
arguments[4][10][0].apply(exports,arguments)
},{"./../utils":36,"dup":10}],31:[function(require,module,exports){
arguments[4][11][0].apply(exports,arguments)
},{"dup":11}],32:[function(require,module,exports){
arguments[4][12][0].apply(exports,arguments)
},{"./../utils":36,"dup":12}],33:[function(require,module,exports){
arguments[4][13][0].apply(exports,arguments)
},{"dup":13}],34:[function(require,module,exports){
arguments[4][14][0].apply(exports,arguments)
},{"./../utils":36,"dup":14}],35:[function(require,module,exports){
arguments[4][15][0].apply(exports,arguments)
},{"./../utils":36,"dup":15}],36:[function(require,module,exports){
arguments[4][16][0].apply(exports,arguments)
},{"dup":16}],37:[function(require,module,exports){
arguments[4][17][0].apply(exports,arguments)
},{"_process":61,"dup":17}],38:[function(require,module,exports){
...
},{"find-insert-index":40,"mergesort":41}],40:[function(require,module,exports){
module.exports = (function () {
  'use strict';
...
},{"../spec/support/taxonomyFixture":42,"./taxonomy":44,"axios":23,"q":47}],44:[function(require,module,exports){
'use strict';
...
},{"flat-to-nested":38,"lodash":46,"tree-model":39}],45:[function(require,module,exports){
/*!
...
},{"_process":61}],48:[function(require,module,exports){
        ...
        render : function() {
            ...
            return(
                React.createElement("ul", null, 
                    ...
                    React.createElement(SubContainer, {content: "outer"}), 
                     React.Children.map(
                        this.props.children,
                        function(child) {
                            console.log(child);
                    ...
                    React.createElement(SubContainer, {content: "after"})
                )
            );
...
SubContainer = React.createClass(
    {displayName: "SubContainer",
        ...
        render : function() {
            ...
            return(
                React.createElement("div", null,  this.state.content, " ",  this.props.content)
            );
...
},{"./RGBColor.js":49,"./geometry/geometry_point.js":55,"./geometry/geometry_rectangle.js":56,"./geometry/geometry_size.js":57}],52:[function(require,module,exports){
...
},{"./accordionPanel":54}],54:[function(require,module,exports){
...
},{"./Container.jsx":48,"./SubContainer.jsx":50,"./Vis.jsx":51,"./VisContainer":52,"./accordion":53,"./tax-example.js":59,"./vis/Tree.js":60}],59:[function(require,module,exports){
...
var Tree = Backbone.Model.extend({
    ...
    renderChart : function() {
        console.log("I can render a chart");
    },
...
console.log('a', this.D3svg());

            var chart = this.D3svg().select('.chart');
            ...
            var bounds = this.get('component').chartBounds();
            ...
            this.nodes.forEach(
                function(d) {
                    ...
                    var fakeText = chart.append('text')
                        .attr('style', 'visibility : hidden;font-size : 11px;cursor : pointer;-webkit-touch-callout: none;-webkit-user-select: none;-khtml-user-select: none;-moz-user-select: none;-ms-user-select: none;user-select: none;')
                .attr('class', 'fake')
                        .text(d.model ? d.model.name : d.name);
...
console.log(this.$elem(), duration);
            ...
            nodeEnter.append("text")
                ...
                .attr("x", function(d) { return (d.children && d.children.length) || d._children ? -10 : 10; })
                .attr("dy", ".35em")
                .attr("text-anchor", function(d) { return (d.children && d.children.length) || d._children ? "end" : "start"; })
                .text(function(d) { return d.model ? d.model.name : d.name; })
                ...
                .on("click", function(d) {
                    ...
                    if ($tree.options().red != undefined && $tree.options().blue != undefined) {
//XXX                        $tree.comparison('Comparing ' + $tree.options().red.name + ' vs ' + $tree.options().blue.name);
                    }
                    else {
//XXX                        $tree.comparison('');
                    }
        ...
        renderChart : function() {
console.log("RC ON TREE", this);
            if (this.dataset() == undefined) {
                  return;
            }
console.log(this.$elem(), this.get('$elem'), this);
