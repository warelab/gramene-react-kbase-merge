...
console.log("ACC PAN", this.state.open);
            return (
                React.createElement("div", {className: "panel panel-default", style: { marginBottom : '2px'}}, 
                    React.createElement("div", {className: "panel-heading", className: "able", role: "tab", style: {padding : '0px'}, onClick: this.handleClick}, 
                    ...
                    React.createElement("div", {className: "panel-body collapse"}, 
                         this.props.body
                    )
                )
            );
